<template>
  <div class="page main-signin-wrapper bg-primary construction">
    <div
      ...
      <a
        class="nav-link icon text-white"
        href="javascript:;">
        <i
    ...
    <div class="container">
      <div
        class="construction1 text-center details text-fixed-white pt-3 pt-sm-0"
        @click="Removebutton">
        <div class="">
          ...
          <h4 class="text-center text-fixed-white fs-30 fw-bold">
            We are Coming soon
          </h4>
          ...
          <div>
            <vue-countdown
              ...
              class="row mt-4 gy-xxl-0 gy-3 mb-5 justify-content-center"
              :time="2 * 24 * 60 * 60 * 1000">
              <!-- Time Remaining：{{ days }} days, {{ hours }} hours, {{ minutes }} minutes, -->
              <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                <div class="p-3 under-maintenance-time rounded">
                  <p class="mb-1 fs-12 op-5">
                    DAYS
                  </p>
