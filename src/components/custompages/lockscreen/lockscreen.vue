  ...
  <div class="page main-signin-wrapper">
    <div
      ...
      <a
        ...
        href="javascript:;">
        <i
          class="fe fe-settings settings-icon text-dark" />
      </a>
    </div>

    <!-- Row -->
    <div
      class="row signpages text-center"
      @click="Removebutton">
      <div class="col-md-12 my-auto">
        <div class="card">
          <div class="row row-sm">
            <div class="col-lg-6 col-xl-5 d-none d-lg-block bg-primary details">
              <div class="mt-4 pt-4 px-5 ms-3 position-absolute">
                ...
                <img
                  ...
                  class="ht-100 mb-0"
                  alt="user">
                <h5 class="mt-4 text-fixed-white">
                  Unlock
                </h5>
                <span class="fs-white-6 fs-13 mb-5 mt-xl-0">Enter your password to access the admin.</span>
              </div>
            </div>
                  ...
                  <div class="card-body main-profile-overview mt-3 mb-3">
                    ...
                    <div>
                      <div class="text-start d-flex float-start mb-4 user-lock">
                        ...
                        <div class="my-auto">
                          <p class="fw-semibold my-auto ms-2 text-uppercase">
                            Sonia Taylor
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="d-grid">
                        <router-link
                          :to="`${url}dashboard`"
                          class="btn ripple btn-primary d-grid mt-4">
                          Unlock
                        </router-link>
                      </div>
                    </div>
