          ...
          <div class="row row-sm">
            <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
              <div class="mt-5 pt-4 p-2 position-absolute">
                <router-link to="/auth/">
                  <img src="https://via.assets.so/img.jpg?w=400&h=150&tc=blue" class="header-brand-img mb-4" alt="logo" />
                </router-link>
                <div class="clearfix"></div>
                <!-- <img src="https://via.assets.so/img.jpg?w=20&h=20&tc=blue" class="ht-100 mb-0" alt="user" /> -->
                ...
                <div class="row row-sm">
                  <div class="card-body mt-2 mb-2">
                    ...
                    <form>
                      ...
                      <router-link :to="`/auth/dashboard`" class="btn ripple btn-primary d-grid">
                        Sign In
                      </router-link>
                    </form>
                    <div class="text-start mt-5 ms-0">
                      ...
                      <div>
                        ...
                        <router-link :to="`/auth/signup`">Register Here</router-link>
                      </div>
                    </div>
                  </div>
                </div>
