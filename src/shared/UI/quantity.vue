<template>
  <button
    class="btn btn-icon btn-light rounded-start-0 input-group-text flex-fill product-quantity-minus"
  ...
  <input
    ...
    aria-label="quantity">
  <button
    class="btn btn-icon btn-light rounded-end-0 input-group-text flex-fill product-quantity-plus"
    @click="incerementValue">
    <i class="ri-add-line" />
  </button>
</template>
