      ...
      <div class="header-content-right">
        ...
        <div class="header-element">
          ...
          <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
            ...
            <li><router-link class="dropdown-item d-flex border-bottom" :to="`/pages/profile`"><i
                  class="fe fe-user fs-16 align-middle me-2"></i>Profile</router-link></li>
            <li><router-link class="dropdown-item d-flex border-bottom" :to="`/apps/mail/mailinbox`"><i
                  class="fe fe-inbox fs-16 align-middle me-2"></i>Inbox <span
                  class="badge bg-success ms-auto">25</span></router-link>
            </li>
            <li><router-link class="dropdown-item d-flex border-bottom" :to="`/pages/settings`"><i
                  class="fe fe-settings fs-16 align-middle me-2"></i>Settings</router-link></li>
            <li><router-link class="dropdown-item d-flex border-bottom" :to="`/advancedui/chat`"><i
                  class="fe fe-headphones fs-16 align-middle me-2"></i>Support</router-link> </li>
            <li><router-link class="dropdown-item d-flex" :to="`/custompages/signin`"><i
...
<script lang="ts" setup>
  ...
  const colorthemeFn = (value: any) => { localStorage.setItem('spruhacolortheme', value); switcher.colorthemeFn(value);
